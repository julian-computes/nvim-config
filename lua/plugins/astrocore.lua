	...
	opts = {
		...
		mappings = {
			...
			n = {
				...
				["<Leader>fA"] = {
					function()
						require("snacks").picker.grep({ dirs = { vim.fn.stdpath("config") }, desc = "Config Files" })
					end,
				...
				["<Leader>uM"] = {
					function()
						local silent = true
						require("astrocore.toggles").buffer_syntax(0, silent)
						require("astrocore.toggles").diagnostics(silent)
						require("astrocore.toggles").cmp(silent)
					end,
